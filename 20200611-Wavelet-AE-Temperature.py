...
plt.title("{}".format("Machine Temperature"))
...
plt.plot(test_data)
plt.grid(True)
plt.fill_between(x, min_score2, max_score2, where=(x > 2126-train_size) & (x < 2692-train_size), facecolor='pink')
plt.fill_between(x, min_score2, max_score2, where=(x > 3703-train_size) & (x < 4269-train_size), facecolor='pink')
plt.fill_between(x, min_score2, max_score2, where=(x > 16057-train_size) & (x < 16623-train_size), facecolor='pink')
plt.fill_between(x, min_score2, max_score2, where=(x > 19232-train_size) & (x < 19798-train_size), facecolor='pink')
plt.xlabel("Index")
plt.ylabel("Value")
plt.show()
...
plt.xlabel("Index")
plt.ylabel("Value")
plt.yticks(np.arange(0, max_score2, 0.1))
plt.show()
...
plt.figure(figsize=figure_size)
plt.subplot(211)
plt.plot(test_data, label="NAB Machine Temperature", color="blue")
plt.plot(point_list, test_value_list, "ro")
plt.grid(True)
plt.fill_between(x, min_value, max_value, where=(x > 2126-train_size) & (x < 2692-train_size), facecolor='pink')
plt.fill_between(x, min_value, max_value, where=(x > 3703-train_size) & (x < 4269-train_size), facecolor='pink')
plt.fill_between(x, min_value, max_value, where=(x > 16057-train_size) & (x < 16623-train_size), facecolor='pink')
plt.fill_between(x, min_value, max_value, where=(x > 19232-train_size) & (x < 19798-train_size), facecolor='pink')
plt.legend()
...
plt.plot(point_list, detect_score_list, "ro")
plt.grid(True)
plt.fill_between(x, min_score, max_score, where=(x > 2126-train_size) & (x < 2692-train_size), facecolor='pink')
plt.fill_between(x, min_score, max_score, where=(x > 3703-train_size) & (x < 4269-train_size), facecolor='pink')
plt.fill_between(x, min_score, max_score, where=(x > 16057-train_size) & (x < 16623-train_size), facecolor='pink')
plt.fill_between(x, min_score, max_score, where=(x > 19232-train_size) & (x < 19798-train_size), facecolor='pink')
plt.legend()
