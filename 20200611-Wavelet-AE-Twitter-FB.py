...
file_name = "realTweets/Twitter_volume_FB.csv"
...
plt.title("{}".format("Twitter Volume FB"))
...
plt.plot(test_data)
plt.grid(True)
plt.fill_between(x, min_score2, max_score2, where=(x > 4614-train_size) & (x < 5404-train_size), facecolor='pink')
plt.fill_between(x, min_score2, max_score2, where=(x > 9926-train_size) & (x < 10716-train_size), facecolor='pink')
plt.xlabel("Index")
plt.ylabel("Value")
plt.show()
...
plt.subplot(211)
plt.plot(test_data, label="NAB Twitter Volume FB", color="blue")
plt.plot(point_list, test_value_list, "ro")
plt.grid(True)
plt.fill_between(x, min_value, max_value, where=(x > 4614-train_size) & (x < 5404-train_size), facecolor='pink')
plt.fill_between(x, min_value, max_value, where=(x > 9926-train_size) & (x < 10716-train_size), facecolor='pink')
plt.legend()
...
plt.plot(point_list, detect_score_list, "ro")
plt.grid(True)
plt.fill_between(x, min_score, max_score, where=(x > 4614-train_size) & (x < 5404-train_size), facecolor='pink')
plt.fill_between(x, min_score, max_score, where=(x > 9926-train_size) & (x < 10716-train_size), facecolor='pink')
plt.legend()
