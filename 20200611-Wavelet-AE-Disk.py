...
file_name = "realAWSCloudwatch/ec2_disk_write_bytes_1ef3de.csv"
...
plt.plot(test_data)
plt.grid(True)
plt.fill_between(x, min_score2, max_score2, where=(x > 2399-train_size) & (x < 2871-train_size), facecolor='pink')
plt.xlabel("Index")
plt.ylabel("Value")
plt.show()
...
plt.subplot(211)
plt.plot(test_data, label="NAB Disk Write", color="blue")
plt.plot(point_list, test_value_list, "ro")
plt.grid(True)
plt.fill_between(x, min_value, max_value, where=(x > 2399-train_size) & (x < 2871-train_size), facecolor='pink')
plt.legend()
...
plt.plot(point_list, detect_score_list, "ro")
plt.grid(True)
plt.fill_between(x, min_score, max_score, where=(x > 2399-train_size) & (x < 2871-train_size), facecolor='pink')
plt.legend()
